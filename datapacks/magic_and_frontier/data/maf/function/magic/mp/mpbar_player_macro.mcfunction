...
$execute if entity @s[scores={mafCastTime=..0,mafCoolTime=1..}] run bossbar set minecraft:mpbar$(mpbar_id) color blue
...
$execute if entity @s[scores={mafCastTime=..0,mafCoolTime=..0}] run execute store result bossbar minecraft:mpbar$(mpbar_id) max run scoreboard players get @s mafMaxMP
$execute if entity @s[scores={mafCastTime=..0,mafCoolTime=..0}] run execute store result bossbar minecraft:mpbar$(mpbar_id) value run scoreboard players get @s mafMP
