...
execute as @e[type=arrow,tag=maf_bow_arrow,tag=ground,nbt={inGround:1b}] at @s run function maf:magic/bow/run_ground with entity @s item.components."minecraft:custom_data".maf
