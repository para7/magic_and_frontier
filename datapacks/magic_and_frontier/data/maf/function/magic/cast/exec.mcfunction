...
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].maf.magic.casting{kind:"active"} run function maf:magic/cast/run_active_effect with storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].maf.magic.casting
