...
function maf:common/eyes_tagged_water
...
execute as @e[type=#maf:enemymob,tag=maf_sight_target,distance=..20,sort=nearest,limit=1] at @s run particle minecraft:end_rod ~ ~0.9 ~ 0.2 0.4 0.2 0.01 18 force
tag @e[type=#maf:enemymob,tag=maf_sight_candidate] remove maf_sight_candidate
tag @e[type=#maf:enemymob,tag=maf_sight_target] remove maf_sight_target
