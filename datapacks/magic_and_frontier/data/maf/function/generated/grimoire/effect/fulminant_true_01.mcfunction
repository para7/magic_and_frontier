...
execute as @e[distance=..15,type=#maf:enemymob,tag=maf_target,limit=1] at @s run execute if block ~ ~ ~ #maf:water as @e[distance=..8.4] run damage @s 192 minecraft:lightning_bolt
execute as @e[distance=..15,type=#maf:enemymob,tag=maf_target,limit=1] at @s run execute unless block ~ ~ ~ #maf:water as @e[distance=..2.2] run damage @s 48 minecraft:lightning_bolt
execute as @e[distance=..15,type=#maf:enemymob,tag=maf_target,limit=1] at @s run damage @s 32 minecraft:lightning_bolt
execute as @e[distance=..15,type=#maf:enemymob,sort=random,limit=1] at @s run summon minecraft:lightning_bolt ~ ~4 ~
