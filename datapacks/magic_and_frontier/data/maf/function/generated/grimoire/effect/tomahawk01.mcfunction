...
execute as @e[type=#maf:enemymob,tag=maf_sight_target,distance=..8,sort=nearest,limit=1] at @s run particle minecraft:cloud ~ ~1 ~ 0.75 0.25 0.75 0.01 12 force
...
damage @e[type=#maf:enemymob,tag=maf_sight_target,distance=..8,sort=nearest,limit=1] 20 minecraft:player_attack by @s
