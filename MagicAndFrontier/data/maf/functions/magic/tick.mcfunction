# 杖の使用判定
execute as @a at @s if entity @s[scores={p7_useWand=1..}] run function maf:magic/check

# 魔法の実行
execute as @a at @s if entity @s[scores={p7_magicID=1..}] run function maf:magic/cast/magic_selector
